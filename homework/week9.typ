...
#hw("6")[
  ...
  #correction[
    ...
    $
      99 - floor(99/4) - floor(99/9) - floor(99/25) - floor(99/49) + floor(99/(4 times 9))
      = 61
    $
  ]
]
...
#hw("7(a,c,h)")[
  ...
  #parts(
    ...
    a: [
      ...
      #correction[
        It's symmetric but not transitive obviously. (e.g. $1 != 2 and 2 != 1 arrow.double.not 1 != 1$.)
      ]
    ],
    c: [The relation is symmetric.],
    h: [The relation is antisymmetric and transitive.],
  )]
